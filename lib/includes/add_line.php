...
<form method="post">
    ...
    <textarea name="equipment_accounted" placeholder="100ft. tubular 1in. webbing, two 10ft. slings, tree protection, accessory cord, 6 Black Diamond carabiners, 2 CAMP single pullies. "cols="30" rows="5" value="<?php !empty($_POST) ? $line->display('equipment_accounted') : ''; ?>"></textarea>
        
    <label for="equipment_needed">Equipment You Want:</label>
    <textarea name="equipment_needed" placeholder="2 linelockers" cols="30" rows="5" value="<?php !empty($_POST) ? $line->display('equipment_needed') : ''; ?>"></textarea>
    ...
    <textarea name="message" placeholder="Come join us at Byrd Park! Anyone is welcome." cols="30" rows="5" value="<?php !empty($_POST) ? $line->display('message') : ''; ?>"></textarea>
